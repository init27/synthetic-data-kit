...
def test_convert_format_with_conversations():
    ...
    conversations = [
        ...
        [
            ...
            {"role": "assistant", "content": "To protect privacy and create diverse training examples."},
        ],
    ]
    ...
    try:
        ...
        assert line1_data["messages"][2]["content"] == "Synthetic data is artificially generated data."
